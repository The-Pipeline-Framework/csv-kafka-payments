...
```bash
TPF_CSV_ADMISSION_PROFILE=slow ./self-host/container/run-container-ha-demo.sh --ci
TPF_CSV_ADMISSION_PROFILE=burst TPF_CSV_AWAIT_TRANSPORT=kafka ./self-host/container/run-container-ha-demo.sh --ci
```
